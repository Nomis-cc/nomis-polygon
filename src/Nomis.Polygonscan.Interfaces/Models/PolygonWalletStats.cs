...
{
    /// <summary>
    /// Polygon wallet stats.
    /// </summary>
    public class PolygonWalletStats 
        : IWalletStats<PolygonTransactionIntervalData>
    {
        /// <summary>
        /// No data.
        /// </summary>
        ...
        /// <inheritdoc/>
        [Display(Description = "Wallet balance", GroupName = "MATIC")]
        ...
        /// <inheritdoc/>
        [Display(Description = "The movement of funds on the wallet", GroupName = "MATIC")]
        ...
        /// <inheritdoc/>
        [Display(Description = "The balance change value in the last month", GroupName = "MATIC")]
        public decimal BalanceChangeInLastMonth { get; set; }

        /// <inheritdoc/>
        [Display(Description = "The balance change value in the last year", GroupName = "MATIC")]
        ...
        /// <inheritdoc/>
        [Display(Description = "NFT trading activity", GroupName = "MATIC")]
        public decimal NftTrading { get; set; }

        /// <inheritdoc/>
        [Display(Description = "NFT worth on wallet", GroupName = "MATIC")]
