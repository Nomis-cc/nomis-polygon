...
{
    /// <summary>
    /// Polygon wallet score calculator.
    /// </summary>
    internal static class PolygonScoreCalculator
    {
        ...
        public static double GetScore(this IWalletStats<PolygonTransactionIntervalData> stats)
        {
            var result = 0.0;
