    ...
    public static class ConfigurationBuilderExtensions
    {
        ...
        public static IConfigurationBuilder AddJsonConfigs(this IConfigurationBuilder manager)
        {
            ...
            return manager
                ...
                .AddJsonFile(Path.Combine(ConfigsDirectory, $"{nameof(PolygonscanSettings).ToLower()}.json"), false, true)
                .AddJsonFile(Path.Combine(ConfigsDirectory, $"{nameof(PolygonscanSettings).ToLower()}.{env}.json"), true, true)
